...
export const WEBVIEW_MESSAGE_DOMAIN: Readonly<Record<WebviewMessageType, WebviewMessageDomain>> = {
  ...
  "agents.assign": "catalog",
  "agents.model.select": "catalog",
  "agents.effort.select": "catalog",
  "agents.model.discover": "catalog",
  "agents.reset": "catalog",
  "localModel.select": "catalog",
  "localModel.enable": "catalog",
